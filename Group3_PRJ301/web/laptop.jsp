                        ...
                        <div id="brand"  class="brand-bg">
                            ...
                            <div class="row">
                                <div class="places-list">
                                    <c:forEach var="l" items="${laptop}">
                                        <div class="place-item"> 
                                            <a href="./ProductDetails?pid=${l.getId()}" class="place-img">
                                                <img src="${l.getImg()}" alt="img">
                                            </a>
                                            <div class="place-body">
                                                <h4 class="place-heading"" href="./ProductDetails?pid=${l.getId()}" class="pr-name">${l.getName()}</a></h4>
                                                <div class="place-price">
                                                    <ins><span>Price: <span class="currencySymbol">$</span>${l.getPrice()}</span></ins>
                                                </div>
                                                <a href="./ProductDetails?pid=${l.getId()}" class="place-buy">ORDER</a>
                                            </div>
                                        </div>
                                    </c:forEach>
                                </div>
