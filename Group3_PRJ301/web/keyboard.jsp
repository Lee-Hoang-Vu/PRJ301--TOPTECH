                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="title">
                                    ...
                                    <h2> Categories</h2>
                                    <ul class="categiri">
                                        <li><a href="phoneList">Phone</a></li>
                        ...
                        <div id="brand"  class="brand-bg">
                            ...
                            <div class="row">
                                <div class="places-list">
                                    <c:forEach var="k" items="${keyboard}">
                                        <div class="place-item"> 
                                            <a href="./ProductDetails?pid=${k.getId()}" class="place-img">
                                                <img src="${k.getImg()}" alt="img">
                                            </a>
                                            <div class="place-body">
                                                <h4 class="place-heading"" href="./ProductDetails?pid=${k.getId()}" class="pr-name">${k.getName()}</a></h4>
                                                <div class="place-price">
                                                    <ins><span>Price: <span class="currencySymbol">$</span>${k.getPrice()}</span></ins>
                                                </div>
                                                <a href="./ProductDetails?pid=${k.getId()}" class="place-buy">ORDER</a>
                                            </div>
                                        </div>
                                    </c:forEach>
                                </div>
