                        ...
                        <div id="brand"  class="brand-bg">
                            ...
                            <div class="row">
                                <div class="places-list">
                                    <c:forEach var="m" items="${mouse}">
                                        <div class="place-item"> 
                                            <a href="./ProductDetails?pid=${m.getId()}" class="place-img">
                                                <img src="${m.getImg()}" alt="img">
                                            </a>
                                            <div class="place-body">
                                                <h4 class="place-heading"" href="./ProductDetails?pid=${m.getId()}" class="pr-name">${m.getName()}</a></h4>
                                                <div class="place-price">
                                                    <ins><span>Price: <span class="currencySymbol">$</span>${m.getPrice()}</span></ins>
                                                </div>
                                                <a href="./ProductDetails?pid=${m.getId()}" class="place-buy">ORDER</a>
                                            </div>
                                        </div>
                                    </c:forEach>
                                </div>
